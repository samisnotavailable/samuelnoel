            ...
            <div className={`padding-global${loading ? ' hidden' : ''}`}>
                <div className='web_page-container'>
                    ...
                    <div className='web-gallery'>
                        ...
                        <img className='web_gallery-div gallery_outer-image' src={ModoTB} alt='website screenshot'></img>
                    ...
                    <div className='web-description'>
                        <div className='web_description-tags'>
                            ...
                            <div id='tag-03' className='description-tag'><h3>home & lifestyle</h3></div>
                            <div id='tag-04' className='description-tag'><h3>shopify</h3></div>
                            <div id='tag-05' className='description-tag'><h3>japanese brands</h3></div>
                        ...
                        <div className='web_description-text'>
                            ...
                            <p className='description-paragraph'>MODO Food & Living is a curated lifestyle shop that brings Japanese craftsmanship from various collections to Filipino homes. My tasks included building its pages and layouts; setting up product and blog management; writing custom Liquid code for pages and sections; and lastly providing a website manual and workshop for website turnover to the client. This screen-responsive website was made on Shopify, using Ecomus v2 theme as a base for the website. MODO Food & Living was developed by me, with the assistance of Jaim Tan, and overall design by Enrico Sebastian Cruz.</p>
                        </div>
                    </div>
                </div>
            </div>
