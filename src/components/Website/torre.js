        ...
        <div className='web-page'>
            {loading && (
                <div className={`preloader${fadeOut ? ' fade-out' : ''}`}>
                    <h1 className='preloader-text'>TORRE LORENZO<br></br>Development Corporation</h1>
                        ...
                        <Link to="https://www.torrelorenzo.com/" target="_blank" rel="noopener noreferrer">
                            <div className='web_hero-container'>
                                ...
                                <div className='hero_video-container'> 
                                    ...
                                    <iframe className='hero-video' src="https://player.vimeo.com/video/1126597530?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479&amp;autoplay=1&amp;muted=1&amp;loop=1&amp;controls=0" frameBorder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerPolicy="strict-origin-when-cross-origin"></iframe>
                                </div>
                            </div>
                        </Link>
                    </div>
